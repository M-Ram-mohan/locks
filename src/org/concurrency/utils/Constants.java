...
public class Constants {
    ...
    public static final int QUEUE_MSG_CNT = 10_000_000;
    // Mux configuration constants
    public static final int MUX_PRODUCERS_CNT = 2;
    public static final int MUX_MSG_CNT = 10_000_000;
    ...
    public static final int DEMUX_CONSUMERS_CNT = 2;
    public static final int DEMUX_MSG_CNT = 10_000_000;
    public static final int DEMUX_QUEUE_SIZE = 1024;
    public static final int DEMUX_BATCH_SIZE = 128;
    // MpMc configuration constants
    public static final int MPMC_PRODUCERS_CNT = 4;
    public static final int MPMC_CONSUMERS_CNT = 4;
    public static final int MPMC_MSG_CNT = 10_000_000;
